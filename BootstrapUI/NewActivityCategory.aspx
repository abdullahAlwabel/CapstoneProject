<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="NewActivityCategory.aspx.cs" Inherits="BootstrapUI.NewActivityCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid row" style="padding-top: 3%">
        <div class="row">
            <div class="col-md-6">
                <h1>Fill in The Activity's Details： </h1>
                <br />
                <asp:Label ID="lblActivityName" runat="server" Text="Activity Name: "></asp:Label>
                <asp:TextBox ID="txtActivityName" placeholder="e.g: type in the Activity Name" class="textboxAbdullah" runat="server"></asp:TextBox>
                <br />
                <br />

                <asp:Label ID="Label2" runat="server" Text=" Activity Category: "></asp:Label>
                <asp:TextBox ID="TextBox2" placeholder="eg: New Category" class="textboxAbdullah" runat="server"></asp:TextBox>
                <br />
                <br />
                ...
                <asp:TextBox ID="txtDate" TextMode="Date" placeholder="eg: 3/5/16" runat="server" class="textboxAbdullah"></asp:TextBox>
                <br />
                <br />
